export default function surstock() {
  return (
    <>
      <div className="mt-40 text-center">
        <div>
          ...
          <p>
            Voiçi votre tableau de surstock, vous pouvez utiliser la barre de
            recherche pour trouver un produit et vous pouvez aussi télécharger
            votre tableau de surstock en format excel en cliquant sur le bouton
            télécharger.
          </p>
        </div>
        <div className="mt-10">
